...
fixes = {
    ...
    'source/articles/企业减资撤资全套税务处理指南(source).html': {
        'after_paragraph': 1,
        'insert': '<p>本文围绕新《公司法》认缴期限收紧背景，系统梳理企业减资、撤资、清算退出三类场景的全流程税务处理，帮助企业避免"补税+滞纳金+罚款"的连锁风险。</p>'
    },
    'source/articles/家族财富传承税务考量与规划(source).html': {
        'after_paragraph': 1,
        'insert': '<p>本文从股权架构、不动产持有、家族信托、跨境资产配置四个维度，为中国高净值家庭提供一套合法、合规、可落地的家族财富传承税务规划框架。</p>'
    },
}
